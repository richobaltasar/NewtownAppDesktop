...
namespace Ewats_App.Testing
{
    public partial class TestReader : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //Establish Context
            retCode = card_function.Card.SCardEstablishContext(card_function.Card.SCARD_SCOPE_USER, 0, 0, ref hContext);
            ...
            retCode = card_function.Card.SCardListReaders(this.hContext, null, null, ref pcchReaders);
            ...
            // Fill reader list
            retCode = card_function.Card.SCardListReaders(this.hContext, null, ReadersList, ref pcchReaders);

            if (retCode != card_function.Card.SCARD_S_SUCCESS)
            {
                mMsg.AppendText("SCardListReaders Error: " + card_function.Card.GetScardErrMsg(retCode));
